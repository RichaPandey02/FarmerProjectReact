    ...
    <div>
      ...
      <div>
        ...
        <p>
          ...
          where it is the spring harvest (otherwise called the winter crop).In
          Indian farming, The rabi crops include wheat, barley, oats (cereals),
          chickpea/gram (pulses), linseed, garlic, cumin, coriander, mustard
          (oilseeds) etc.In India the major rabi crop like wheat, mustard and
          peas harvested early. Most of the rabi crops including wheat, barley,
          oats (cereals), chickpea/gram (pulses), linseed, mustard planted in
      ...
      <div className="wrapper">
        ...
        <div>
          ...
          <h5>
            ...
            varieties worldwide. Bread wheat, or common wheat, is the primary
            species. ...{" "}
          </h5>
        </div>
        <div>
          <img
            src="https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Z2FybGljfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
            style={{ height: "150px" }}
          />
        ...
        <div>
          ...
          <h5>
            ...
            variously known as gram or Bengal gram, garbanzo or garbanzo bean,
            or Egyptian pea. Chickpea seeds are high in protein.
          </h5>
        </div>
        <div>
          <img
        ...
        <div>
          ...
          <h5>
            ...
            plants' pungent seeds. The leaves and swollen leaf stems of mustard
            plants are also used, as greens, or potherbs.
          </h5>
        </div>
        <div>
          <img
          ...
          <h5>
            ...
            resulting yellow-brown latex, which is scraped off of the pod, is
            bitter in taste and contains varying amounts of alkaloids such as
        ...
        <div>
          ...
          <h5>
            ...
            production in breastfeeding mothers. Fenugreek may also reduce
            cholesterol levels, lower inflammation, and help with appetite
            control, but more research is needed in these areas.
          </h5>
        </div>
        <div>
          <img
          ...
          <h5>
            ...
            Since ashwagandha is traditionally used as an adaptogen, it is used
            for many conditions related to stress. Adaptogens are believed to
            help the body resist physical and mental stress.
          </h5>
        </div>
        <div>
          <img
          ...
          <h5>
            ...
            same name (usually in the plural, unlike other cereals and
            pseudocereals).
          </h5>
        </div>
        <div>
          ...
          <h5>
            ...
            Lentils are relatively quick and easy to prepare, and their low cost
            makes them an accessible form of high quality protein for many
        ...
        <div>
          ...
          <h5>
            ...
            parsley, carrots, and celery. In the United States, Coriandrum
            sativum seeds are called coriander, while its leaves are called
            cilantro. ... The plant is also known as Chinese parsley.
          </h5>
        </div>
        ...
        <div>
          ...
          <h5>
            ...
            some varieties are red, brown, black, or purple ( 1 ). There are
            many species of sorghum, the most popular being Sorghum bicolor,
        ...
        <div>
          ...
          <h5>
            ...
            first cultivated grains, particularly in Eurasia as early as 10,000
            years ago. ... It is used in soups and stews, and in barley bread of
            various cultures.
          </h5>
        </div>
      </div>
