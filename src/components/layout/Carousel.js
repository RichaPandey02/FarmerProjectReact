...
<section id= "slider" className="carousel-slider">
  ...
  <div className= "slides">
    <div className= "slide">
      <a href= "#"><img src= "https://pbs.twimg.com/profile_images/1195420542196568064/Rk6QLKCu.jpg" alt="slide-1" /></a>
    </div>
    <div className= "slide">
      <a href= "#"><img src= "https://i1.wp.com/www.nationofchange.org/wp-content/uploads/2017/03/2012721101822590734_20.jpg?fit=800%2C450&ssl=1" alt="slide-1" /></a>
    </div>
    <div className= "slide">
